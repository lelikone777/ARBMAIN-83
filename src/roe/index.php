...
/*        @media (orientation: landscape) and (max-height: 380px) and (max-width: 730px) {
            .main {
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="content blok1">
                <p class="orange">Pentru a obține acces la serviciu, faceți clic pe butonul de mai jos pentru a trimite un cod SMS unic.</p>

                <p class="price">
                Cost total serviciu: 3,62 EUR cu TVA (cost mesaj trimis catre 1252: 0,06 EUR cu TVA si cost mesaj primit: 3,56 EUR cu TVA)
                </p>
                <a class="btn btn-primary" id="smsClick" href="<?= $sms_body ?>">Click aici </a>
            </div>
        </div>
